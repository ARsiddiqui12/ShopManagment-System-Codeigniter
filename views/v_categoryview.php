                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 b-r">
                                ...
                                <tbody>
                                <tr>
                                   <th colspan="2"> <img src="<?php echo base_url(); ?>categoryuploads/<?php echo $value->logo; ?>" width="250" height="250" style="border:2px solid #ccc;"></th>
                                </tr>
                                <tr>
                                    <th>Category Name </th>
                                ...
                                <tr>
                                    ...
                                    <th width="950"> <?php $a=explode(".",$value->categoryadding_date);
                                echo $a[0];
